...
For v3, the exact successful Verify report owns the final explanation, verification basis, and authority. Reject missing, stale, new, or competing authoritative rationale. V1/v2 use standalone explanation plus Verify.
