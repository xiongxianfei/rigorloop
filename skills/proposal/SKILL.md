...
Write the bounded direction in the existing proposal surface and explicitly record its subject and your owned work. Identify affected model documents without drafting separate specification or architecture siblings. Leave proposal judgment to an independent reviewer and activity selection to route. Preserve existing findings and other actors' entries.
