...
For each material concern, preserve stable identity, reporter, subject/location, evidence, required outcome, correction owner or necessary owner decision, and actionable rationale. Keep unresolved origin and supporting judgment understandable. Optional improvements are labeled advisory, not open required fixes. Use existing narrative fields for severity and specialist attribution where the contract has no dedicated field.
