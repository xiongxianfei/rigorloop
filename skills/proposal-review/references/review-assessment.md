...
For v3 Review, supply a nonempty summary and assessment_scope, at least one complete rationale string, and an explicit limitations array. Keep judgment, findings, actors and exact subjects in their authoritative fields; do not repeat their lists or status in explanation. Multiline reasons are allowed. Historical reviews remain unchanged archives; never infer or mechanically convert old approvals into named fields.
