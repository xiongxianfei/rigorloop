...
Select exact responsibilities, sections, decisions and consumers before moving authority. Map every displaced numbered and unnumbered obligation to its destination, explicit supersession or justified retention. Preserve decision context, alternatives, consequences and applicable constraints. Resolve contradictions; copying conflicting clauses together is not consolidation.

For architecture/ADR source adoption, preserve relevant goals/constraints, context, structure, runtime/deployment and crosscutting concerns in the owning Design. Map original decision identities, context, choice, alternatives, consequences and follow-up to their surviving owner or explicit supersession. Preserve any unaffected responsibility in its existing source; incomplete or conflicting authority stops before writes.
