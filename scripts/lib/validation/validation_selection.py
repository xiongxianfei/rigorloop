...
CHECK_CATALOG["validation_execution.regression"] = CheckCatalogEntry(
    "validation_execution.regression", "python tests/engineering/validation/test-validation-execution.py", "selector", label='Run validation executor fixtures', modes=('broad-smoke',),
    )
...
CHECK_CATALOG['adapters.full_regression'] = CheckCatalogEntry(
    'adapters.full_regression', 'python tests/engineering/packaging/test-adapter-distribution.py', 'broad-smoke',
...
_CASE_ASSESSMENTS = {
    ...
    'boundary_first.reference_regression': 'ea3fdbd81fa7dc5e9131e31aed4dbda864505f7d11084ec8512341510a35af09',
    'boundary_first.regression': '8af0a849cf6a3a3721620ac7c2cfce1e8e6898e96f995ac0489594ad2d31bd67',
    'documentation_prose.regression': 'eafd742dbd4c1fd31c3f3e3e8b7fc25e59f2039e6c3d715621f446a761de8760',
    'markdown_readability.regression': '61726c7a026e40737d4c4148af7e2522ceb165a380f5e924c309e562008f3627',
    'guide_system.regression': '9da4a6214ef68d715dfcfb976618152184657c5acb272da346fe37c59229fb52',

    'validation_execution.regression': 'c2382f0488e61f29b9503463dfcdb1e20f188b3d4f729ca436753ba9fd822ac7',
    'change_metadata.regression': '0a1a6859ddf76226897a3e8d2c774c118e8c2f6f04f04edeeca8325867e9823f',
    'selector.regression': '0d064ae19c32b73c3f95cd53c8832892dc9891055a553fa974c7eda2acdd57fe',
}
...
def _support_subject_paths(repo_root: Path, change_root: str) -> set[str] | None:
    ...
    validator = Path(__file__).resolve().parents[2] / "validate-record-store.mjs"
    try:
        result = subprocess.run(
...
_TOOL_PACKAGE_CHECKS = {'scripts/lib/validation/__init__.py': ('adapters.regression',
 ...
 'scripts/lib/packaging/__init__.py': ('adapters.drift',
                                       'adapters.regression',
                                       'adapters.validate',
                                       'npm_package_publication.test',
                                       'rigorloop_cli.test'),
 'scripts/lib/release/__init__.py': ('release_transaction.regression',),
 'scripts/lib/__init__.py': ('adapters.drift',
                             'adapters.regression',
                             'adapters.validate',
                             'boundary_first.reference_regression',
                             'boundary_first.regression',
