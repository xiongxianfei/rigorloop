...
from lib.release.release_candidate import SOURCE_REPOSITORY, local_file, run
from lib.release.release_execution import ExecutionError, ExternalUnavailable, public_files
from lib.release.release_transaction import NetworkPublicEvidenceProvider, PublicSmokeResult
...
class NetworkPublisher(NetworkPublicEvidenceProvider):
    ...
    def run_public_npx_smoke(self, *, command: str, cwd: Path) -> PublicSmokeResult:
        ...
        if target == 'version':
            ...
            from lib.release.release_transaction import _target_install_roots
