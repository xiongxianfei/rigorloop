...
for (const relative of ["schemas/record-store-transport.schema.json", "schemas/targeted-recording-v1.schema.json", "schemas/rigorloop-records-v2.schema.json", "templates/rigorloop-records-v2/records.json"]) {
