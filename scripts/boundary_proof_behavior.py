...
def _render_feature_markdown(payload: Mapping[str, object]) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "A successful call returns the selected mode and normalized text. `trim` removes leading and trailing Unicode whitespace; `preserve` returns the input unchanged. Every other mode returns only `unknown-mode` and no text.",
            "",
            "## Compatibility",
            "",
            ...
            "## Acceptance criteria",
            "",
            "- Both valid modes produce the requirement-defined result.",
