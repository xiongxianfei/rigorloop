    ...
    *,
    ...
    structure_instruction = {
        ...
        "test-spec": (
            ...
            "For each proof row, compute the union of governing requirement "
            "IDs owned by every cited boundary and interaction. Require the "
            "proof row's governing requirements to be a subset of that union "
            "and to overlap the owner set of every cited reference; split the "
            "row or remove a governing requirement when either check fails. "
            "Before returning, audit this ownership rule for every proof row. "
