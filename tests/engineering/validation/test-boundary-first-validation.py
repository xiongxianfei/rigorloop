...
from lib.validation.boundary_first_validation import (
...
class ModelRecordTests(unittest.TestCase):
    ...
    def test_model_current_files_validate_without_activation_or_change_record(self):
        for relative in ['docs/design/system.md', 'docs/design/skill/authoring/authoring.md', 'docs/design/skill/authoring/proposal.md', 'docs/design/skill/authoring/design.md', 'docs/design/skill/authoring/plan.md', 'docs/design/skill/workflow.md', 'docs/design/skill/assessment.md', 'docs/design/cli/records.md', 'docs/design/cli/installation.md', 'docs/design/engineering/validation.md', 'docs/design/engineering/packaging.md', 'docs/design/engineering/release.md', 'docs/design/skill/skill.md', 'docs/design/cli/cli.md', 'docs/design/engineering/engineering.md', 'docs/design/skill/project-foundations/project-foundations.md', 'docs/design/skill/project-foundations/vision.md', 'docs/design/skill/project-foundations/constitution.md', 'docs/design/skill/project-foundations/project-map.md', 'docs/design/skill/discovery/discovery.md', 'docs/design/skill/discovery/explore.md', 'docs/design/skill/discovery/research.md', 'docs/design/skill/learning.md', 'docs/design/skill/delivery-handoff.md']:
