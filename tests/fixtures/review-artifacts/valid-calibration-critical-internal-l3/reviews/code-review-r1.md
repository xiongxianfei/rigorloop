...
Target: tests/fixtures/review-artifacts/valid-calibration-critical-internal-l3
...
Review target identity: tests/fixtures/review-artifacts/valid-calibration-critical-internal-l3@HEAD
...
Adversarial hypotheses tested: critical internal calibration records require L3 or human authority evidence
...
Confidence: medium
No-finding rationale: The fixture records critical-internal authority evidence without claiming measured-corpus status.
...
Falsifiable review questions: Does a critical-internal record include accepted L3 authority evidence?
Calibration record: yes
Calibration record ID: calibration-code-review-critical-internal-r1
