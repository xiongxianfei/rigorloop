...
Adversarial hypotheses tested: unsupported independence level fails closed
...
Highest-impact failure modes: unsupported independence level could be coerced
Changed boundaries: review artifact parser
Evidence expected: negative validator fixture
Areas requiring direct inspection: independence level field
Areas intentionally out of scope: workflow routing
Risk classes considered: contract mismatch
Falsifiable review questions: Does unsupported independence level fail
