...
Adversarial hypotheses tested: unsupported native review status fails closed
...
Highest-impact failure modes: unknown native review status could advance
Changed boundaries: review artifact parser
Evidence expected: negative validator fixture
Areas requiring direct inspection: native review status field
Areas intentionally out of scope: workflow routing
Risk classes considered: contract mismatch
Falsifiable review questions: Does unsupported native review status fail
