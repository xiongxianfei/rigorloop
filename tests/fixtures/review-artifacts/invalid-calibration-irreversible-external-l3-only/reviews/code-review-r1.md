...
Target: tests/fixtures/review-artifacts/invalid-calibration-irreversible-external-l3-only
...
Review target identity: tests/fixtures/review-artifacts/invalid-calibration-irreversible-external-l3-only@HEAD
...
Confidence: medium
No-finding rationale: This negative fixture intentionally uses L3 where human authority is required.
...
Falsifiable review questions: Does an irreversible external record with only L3 fail closed?
Calibration record: yes
Calibration record ID: calibration-code-review-irreversible-external-invalid-r1
...
Second reviewer type: heterogeneous-model
