...
- Installation dependency: [CLI Installation](../docs/design/cli/installation.md); the original lockfile dependency is historical. The CLI/Record Format models own current recording mechanics.
