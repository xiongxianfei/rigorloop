...
| compatibility-migration | applicable | UBR-R006, UBR-R007, UBR-R013, UBR-R015, UBR-R019, UBR-R021 | BND-COMPAT-001 | - |
...
| BND-COMPAT-001 | compatibility-migration | UBR-R006, UBR-R007, UBR-R013, UBR-R015, UBR-R019, UBR-R021 | pending snapshot; active frozen inventory; historical accepted specs; new or substantively revised specs; stage-owned owner-pointer marker form; non-stage-owned status marker form; marker before authority; marker outside governed metadata; duplicate marker; retired custom activation-release experiment; retained routine release mechanism; v0.3.6 rollback | Historical contracts remain valid; active checked-revision adoption uses the frozen inventory; each feature spec uses exactly one marker location authorized by its lifecycle contract; the custom experiment is absent; the routine release mechanism remains authoritative. | Existing specs remain usable; the authorized exact-one marker form validates; a before-pointer, outside-section, or duplicate marker fails; new work adopts automatically; stale custom dependencies fail; routine release proceeds unchanged; rollback selects v0.3.6. | UBR-R019 |
