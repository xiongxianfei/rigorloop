...
[Design](../docs/design/design/design.md) owns model authoring; [Workflow](../docs/design/workflow/workflow.md) owns coordination; [Review and Closeout](../docs/design/review-closeout/review-closeout.md) owns assessment policy; [Test](../docs/design/test/test.md) owns shared test criteria; [Record Format](../docs/design/record-format/record-format.md) and [CLI](../docs/design/cli/cli.md) own v2 representation/mechanics. Installation does not adopt project governance. Specialist proposal content and judgment remain at their existing owners. Operational manifests, templates and packaged methods keep their existing paths.
