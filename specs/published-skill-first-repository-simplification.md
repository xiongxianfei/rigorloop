...
## Unified Validation applicability

For the [unified Validation initiative](../docs/proposals/2026-09-12-unified-validation-model.md), [Validation](../docs/design/engineering/validation.md#source-disposition-and-decision-preservation) supplies the exact new-profile-only R14/R15/R17–20/R22/R25 replacement for its mapped sources, checks and consumer changes. VAL-SR-13 preserves protected-failure mapping, unknown-protection investigation, established retained proof and recoverable removal. Existing Design/Delivery/evidence surfaces carry that rationale without a second ledger, mandatory savings benchmark or execution of deliberately retired cache behavior. Extracting the current executor and replacing duplicated schedulers/classification is permitted within that mapped scope; it does not authorize another public runner or competing scheduler.

This amendment takes effect only with reviewed coherent implementation and successful Verify of [the owning change](../docs/changes/2026-09-12-unified-validation-model/change.json). R21's publication boundary and every unselected clause/population retain their owners. Earlier cleanup and stored-format retirement exceptions keep their exact scope; historical IDs, records and judgments remain unchanged.

## Release-model ownership applicability

For the selected [Release consolidation](../docs/proposals/2026-09-09-release-model-source-consolidation.md), [Release REL-SR-08/09](../docs/design/engineering/release.md#requirements) completely replaces the standing R7/R8 definition at reviewed coherent implementation and successful Verify. This new-profile-only amendment transfers current skill/package proof composition and deterministic version, package metadata, archive inventory/checksum, release metadata, tracked-note, generated parity and rollback/release-consistency obligations with their existing applicability. The R7/R8 transfer preserves these protective obligations, command/result aliases and explicit freshness policy. Release separately selects bounded approval-driven coordination and a diagnostic timing consequence under REL-SR-18/22–24; directly affected check implementations and consumers must adopt those exact amendments together. Passing checks still grants no publication authority. Until adoption R7/R8 remain operational here; afterward their original text below is historical identity, not a second maintained definition. All other clauses, boundary/proof IDs and their current scoped amendments retain their owners.

## Necessary-design cleanup applicability

For the selected [necessary-design consolidation](../docs/proposals/2026-09-09-consolidate-necessary-design-and-retire-superseded-sources.md), [Validation TEST-SR-14](../docs/design/engineering/validation.md#proof-quality-maintenance-and-evidence) supplies the complete scoped R14/R17–20/R22 replacement, and [System's consolidation map](../docs/design/system.md#necessary-design-consolidation-map) names exact sources, preserved populations and consumers. This new-profile-only amendment takes effect with reviewed coherent implementation and successful Verify. It preserves the historical feature/boundary/proof identifiers and the unselected operational remainder.
