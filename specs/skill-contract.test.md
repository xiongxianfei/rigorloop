...
- Current resource-integrity architecture: [System Architecture](../docs/architecture/system/architecture.md) and [ADR-20260623 Published Skill Resource Integrity](https://github.com/xiongxianfei/rigorloop/blob/39b7c5cb1f03aa761d2f2493d3474ce985e59d6f/docs/adr/ADR-20260623-published-skill-resource-integrity.md), approved and accepted.
