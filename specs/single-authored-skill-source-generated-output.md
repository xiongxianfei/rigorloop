...
For this selected new profile, Distribution replaces R2/10–17/68/71's separate local Codex mirror capability and proof with its DIST-SR-05/18/19 package path. R1/3–5/18–42/49–60/67/69/70/72/73 consume Distribution for current delivery while Skill retains content ownership. R47's approved support-change exception applies to withdrawal of OpenCode. Historical migration sequence R6–9/43–48 and measurement/source-selection R61–66 retain their original applicability; no new benchmark or historical rewrite is selected.
