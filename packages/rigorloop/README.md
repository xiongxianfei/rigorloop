...
```bash
npx @xiongxianfei/rigorloop@0.4.1 init codex --json
npx @xiongxianfei/rigorloop@0.4.1 init claude --json
npx @xiongxianfei/rigorloop@0.4.1 init opencode --json
```

Preview the write plan without mutating files:

```bash
npx @xiongxianfei/rigorloop@0.4.1 init opencode --dry-run --json
```
...
```bash
npx @xiongxianfei/rigorloop@0.4.1 init codex --from-archive ./rigorloop-adapter-codex-v0.4.1.zip --json
npx @xiongxianfei/rigorloop@0.4.1 init claude --from-archive ./rigorloop-adapter-claude-v0.4.1.zip --json
npx @xiongxianfei/rigorloop@0.4.1 init opencode --from-archive ./rigorloop-adapter-opencode-v0.4.1.zip --json
```
...
```bash
npx @xiongxianfei/rigorloop@0.4.1 new-change my-change --title "Describe the change" --json
```

Preview the scaffold first:

```bash
npx @xiongxianfei/rigorloop@0.4.1 new-change my-change --title "Describe the change" --dry-run --json
```
