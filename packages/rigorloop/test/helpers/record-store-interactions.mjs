...
export function runInteraction(scenario,mode,{guidance=true}={}){
 ...
 if(guidance&&mode==='advanced')add('guidance','Controlled comparison amendment: select advanced rigorloop-records-v3 request schema 2 for these identical v2 fixtures, overriding the historical skill profile v1-only selector. This is comparative maintenance tooling, not a shipped v2 normal path. Preserve all supplied decisions and neighbors.');
