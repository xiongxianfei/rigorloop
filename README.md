...
- Historical explanations formerly under `docs/explain/` are retained with their original plans; see the [retired-path mapping](docs/plan-archive.md#retired-explanation-paths). New work records its final explanation in the owning change’s contract-selected Verify report.
