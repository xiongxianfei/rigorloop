...
## Active
- [2026-05-23 Public Discovery and Developer Adoption Surface](plans/2026-05-23-public-discovery-and-developer-adoption-surface.md) - branch-ready after local final verify; improves GitHub repository metadata, README first-contact adoption, Quick Start freshness, Mermaid lifecycle visual, contribution/security routing, npm landing alignment, and durable proof evidence without runtime behavior changes; PR handoff is next.
