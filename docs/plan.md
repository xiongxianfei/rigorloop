...
| --- | --- | --- | --- |
| [Portable Boundary-First Capability for Published Skills](plans/2026-07-27-portable-boundary-first-capability-for-published-skills.md) | active | implement M3 under the active workflow implementation authority | 2026-07-27-portable-boundary-first-capability-for-published-skills-review-recording |
