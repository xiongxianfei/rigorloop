...
## Active
- [2026-06-23 Published Skill Resource Integrity Architecture Pilot](plans/2026-06-23-published-skill-resource-integrity-architecture-pilot.md) - active; next stage: implement M3; change: `2026-06-22-published-skill-resource-integrity-architecture-pilot`.
