...
## Active
- [2026-06-18 Workflow Skill Artifact-Location Map](plans/2026-06-18-workflow-skill-artifact-location-map.md) - active; current milestone: M2 resolution-needed; next stage: review-resolution; change: `2026-06-17-workflow-skill-artifact-location-map`.
