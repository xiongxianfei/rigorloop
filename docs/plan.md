...
## Active
- [2026-05-25 Adopter-Facing Vision and README Principle Rewrite](plans/2026-05-25-adopter-facing-vision-and-readme-principle-rewrite.md) - active execution plan for rewriting `VISION.md` and README adopter-facing positioning while preserving README marker ownership, command-source boundaries, worked-example follow-up discipline, cold-read evidence, and no-runtime-change proof; `VRP-CR-M1-F1` is closed by accepted branch-specific cold-read evidence and M1 is review-requested for code-review rerun.
