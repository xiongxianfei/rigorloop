...
| [Boundary-First Proof Modeling for Published Lifecycle Skills](plans/2026-07-25-boundary-first-proof-modeling.md) | active | architecture and plan correction for BFP-CR-M2-8, then review-resolution and implement M2 corrections | 2026-07-25-boundary-first-proof-modeling-for-published-lifecycle-skills |
