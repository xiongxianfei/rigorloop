...
| --- | --- | --- | --- |
| [Workflow-State Projection and Pre-Transition Synchronization Gate](plans/2026-06-23-workflow-state-projection-and-pre-transition-synchronization-gate.md) | active | explain-change | `2026-06-23-workflow-state-projection-and-pre-transition-synchronization-gate` |
