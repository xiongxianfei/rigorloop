...
| --- | --- | --- | --- |
| [Portable Boundary-First Capability for Published Skills](plans/2026-07-27-portable-boundary-first-capability-for-published-skills.md) | active | code-review M3 R1 for the lightweight activation implementation | 2026-07-27-portable-boundary-first-capability-for-published-skills-review-recording |
