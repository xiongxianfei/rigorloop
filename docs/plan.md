...
| --- | --- | --- | --- |
| [Preflight-First Validation Runtime Optimization](plans/2026-06-26-preflight-first-validation-runtime-optimization.md) | active | code-review (final holistic) | 2026-06-26-preflight-first-validation-runtime-optimization |
