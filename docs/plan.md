...
## Active
- [2026-05-25 Adopter-Facing Vision and README Principle Rewrite](plans/2026-05-25-adopter-facing-vision-and-readme-principle-rewrite.md) - active execution plan for rewriting `VISION.md` and README adopter-facing positioning while preserving README marker ownership, command-source boundaries, worked-example follow-up discipline, cold-read evidence, and no-runtime-change proof; code-review-m1-r1 blocked M1 on missing genuine cold-read evidence and M1 is in resolution-needed.
