...
| [Boundary-First Proof Modeling for Published Lifecycle Skills](plans/2026-07-25-boundary-first-proof-modeling.md) | active | spec revision for R35 preflight and manifest consistency | 2026-07-25-boundary-first-proof-modeling-for-published-lifecycle-skills |
