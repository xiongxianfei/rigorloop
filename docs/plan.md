...
| --- | --- | --- | --- |
| [Portable Boundary-First Capability for Published Skills](plans/2026-07-27-portable-boundary-first-capability-for-published-skills.md) | active | amend and rereview the M4 proof command before implementation | 2026-07-27-portable-boundary-first-capability-for-published-skills-review-recording |
