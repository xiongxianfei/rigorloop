...
## Active
- [2026-05-23 Release Process Contract](plans/2026-05-23-release-process-contract.md) - active execution plan for implementing the standing release-process contract; M1 through M4 are closed after clean code-reviews, explain-change is recorded, final verify passed, and PR #89 is open for hosted CI and human review; blockers: none.
