...
## Active
- [2026-05-25 Adopter-Facing Vision and README Principle Rewrite](plans/2026-05-25-adopter-facing-vision-and-readme-principle-rewrite.md) - active execution plan for rewriting `VISION.md` and README adopter-facing positioning while preserving README marker ownership, command-source boundaries, worked-example follow-up discipline, cold-read evidence, and no-runtime-change proof; M1 is closed after code-review-m1-r3, explain-change is recorded, and verify is next.
