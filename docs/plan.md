...
| --- | --- | --- | --- |
| [Portable Boundary-First Capability for Published Skills](plans/2026-07-27-portable-boundary-first-capability-for-published-skills.md) | active | test-spec revision for PBF-TSR6 and PBF-TSR7, then test-spec-review R5 | 2026-07-27-portable-boundary-first-capability-for-published-skills-review-recording |
