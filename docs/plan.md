...
| --- | --- | --- | --- |
| [Boundary-First Proof Modeling for Published Lifecycle Skills](plans/2026-07-25-boundary-first-proof-modeling.md) | active | spec revision for snapshots and operation registry | 2026-07-25-boundary-first-proof-modeling-for-published-lifecycle-skills |
