...
## Active
- [2026-05-23 Public Discovery and Developer Adoption Surface](plans/2026-05-23-public-discovery-and-developer-adoption-surface.md) - active execution plan for improving GitHub repository metadata, README first-contact adoption, Quick Start freshness, Mermaid lifecycle visual, contribution/security routing, npm landing alignment, and durable proof evidence without runtime behavior changes; M1, M2, M3, and M4 are closed after clean code-review and M5 lifecycle closeout is review-requested.
