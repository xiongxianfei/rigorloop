...
| --- | --- | --- | --- |
| [Single Bounded Review-Fix Workflow Automation](plans/2026-07-21-single-bounded-review-fix-workflow-automation.md) | active | review-resolution M5 | 2026-07-20-single-bounded-review-fix-workflow-automation-mechanism |
