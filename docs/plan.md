...
## Active
- [2026-05-22 Bounded Plan Index and Completed-Plan Archive](plans/2026-05-22-bounded-plan-index-and-completed-plan-archive.md) - implementation milestones closed after clean M6 code-review and explain-change refreshed; next: verify; blockers: none.
