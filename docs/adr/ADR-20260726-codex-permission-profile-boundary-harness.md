...
Accepted `ADR-20260726-stage-authored-artifact-envelope-transport` supersedes
only this ADR's writable-workspace,
...
All other decisions in this ADR remain accepted.
