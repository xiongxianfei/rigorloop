...
- Create the matching boundary-first proof map before implementation, including unknown vocabulary, visible member maps, governed invalidation, stale lifecycle input, atomic settlement, finding-owner mapping, non-approved blockers and next actions, isolated settlement, authorized stage advancement, invalid-edge rejection, synchronized automation projection, correction routing, legacy-dependent cutover blocking, pre-adoption revert, and generated-parity cases.
