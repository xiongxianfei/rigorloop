...
- Published current preservation run
  `run-21e1ee9615edbaa0feb47ea0905d2c1b`.
...
| `python scripts/boundary_proof_behavior.py generate-preservation --change-id 2026-07-25-boundary-first-proof-modeling-for-published-lifecycle-skills` | structural-pass; 40 pairs; zero upstream invocations |
| `python scripts/boundary_proof_behavior.py validate-preservation --change-id 2026-07-25-boundary-first-proof-modeling-for-published-lifecycle-skills` | structural-pass; 40 pairs; zero upstream invocations |
| `git diff --check` | pass |
...
The harness reports only `structural-pass`: structure, origin, identity,
completeness, and absence of upstream reinvocation. It marks every pair as
