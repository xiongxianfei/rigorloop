...
This authorization does not extend to implementation, external platform mutation, push, PR, release, deployment, merge, destructive Git operations, credentials, live repair execution, or target-agent runtime execution.
