...
This evidence covers M2 canonical skill and asset changes for the spec-review routing/readiness contract.
...
| Generated adapters | Previous generated output came from canonical skill source. | M2 validates generated local skill output with `python scripts/build-skills.py --check`; M3 owns public adapter archive proof. | current for local generation |
