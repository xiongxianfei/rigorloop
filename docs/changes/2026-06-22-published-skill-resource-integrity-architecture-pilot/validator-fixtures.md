...
| Legacy unmapped reference | `test_published_skill_legacy_template_loading_instruction_fails`. |
| False-positive boundary | `test_published_skill_legacy_lint_avoids_examples_and_docs_paths`. |
| Temporary architecture migration debt | `test_current_architecture_legacy_references_are_temporary_migration_debt`. |
