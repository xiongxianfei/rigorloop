...
Owner: implementer
Owning stage: implement
Chosen action: Update the legacy-resource lint instruction assembly so a resource-loading verb in one Markdown instruction or list item does not apply to separate artifact/example paths in another instruction.
