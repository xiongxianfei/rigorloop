...
The repository-maintainer therefore defers registration for each exact path instead of adding a proposal-review-simplification registry entry, selector branch, validator family, or broad fixture route. This follows the existing owner-deferral contract and the approved non-goal against permanent simplicity infrastructure.
...
CI maintenance records routing ownership only. Validation execution and branch-ready judgment remain owned by `verify`.
