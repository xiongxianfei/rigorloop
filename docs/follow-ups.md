...
| --- | --- | --- | --- | --- | --- | --- |
| FU-005 | Implement `rigorloop new-change` artifact pack scaffolding | docs/proposals/2026-05-15-rigorloop-scaffolding-cli-and-machine-readable-workflow.md | proposal | proposal | open | Implementation milestones are closed in `docs/plans/2026-05-16-rigorloop-cli-new-change.md`; explain-change is recorded, final local verify passed, and PR #64 is open pending hosted CI and human review. |
