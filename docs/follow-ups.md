...
| FU-010 | Harden npm release pipeline for RigorLoop CLI package | docs/proposals/2026-05-15-rigorloop-scaffolding-cli-and-machine-readable-workflow.md | plan | docs/plans/2026-05-16-rigorloop-npm-publication.md | open | Active in `docs/plans/2026-05-16-rigorloop-npm-publication.md`; keep open until `@xiongxianfei/rigorloop@0.1.4` publication evidence, post-publication npm smoke, and actual non-dry-run Codex adapter install proof are recorded in `docs/releases/v0.1.4/npm-publication.md`. |
