...
| FU-012 | Consolidate skill/resource and validation architecture | docs/design/system/system.md#adoption-and-follow-up-ownership | proposal | proposal, then owning Design | open | Repository maintainer accountable; Route assigns the receiving proposal author and subsequent Design owner. Inventory retained skill/resource and validation responsibilities and propose the next bounded owning Design set. |
