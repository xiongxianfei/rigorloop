...
- Review status: `code-review-m1-r2` requested changes for `CBR-M2-CR2-1`
- Remaining in-scope implementation milestones: M1 requires targeted review-resolution and fix; no later implementation milestones are in scope
- Next stage: review-resolution for `CBR-M2-CR2-1`
- Final closeout readiness: not ready
- Reason final closeout is or is not ready: `CBR-M2-CR2-1` remains open, and explain-change, verify, and PR are not complete.
...
- Ready for `review-resolution` for `CBR-M2-CR2-1`, not final closeout.
