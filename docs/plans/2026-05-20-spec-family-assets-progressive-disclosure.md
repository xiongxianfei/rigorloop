...
- Reason final closeout is or is not ready: all in-scope implementation milestones are closed; explain-change, final verify, and PR handoff remain incomplete.
