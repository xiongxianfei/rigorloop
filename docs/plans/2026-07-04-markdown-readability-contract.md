...
- `python scripts/validate-review-artifacts.py --mode structure docs/changes/2026-07-04-markdown-readability-contract`: passed after code-review M1 R2 with 7 reviews, 4 findings, 7 log entries, and 4 resolution entries.
- `python scripts/validate-change-metadata.py docs/changes/2026-07-04-markdown-readability-contract/change.yaml`: passed after code-review M1 R2.
- `python scripts/validate-artifact-lifecycle.py --mode explicit-paths --path docs/proposals/2026-07-04-markdown-readability-contract.md --path specs/markdown-readability-contract.md --path specs/markdown-readability-contract.test.md --path docs/plans/2026-07-04-markdown-readability-contract.md --path docs/plan.md --path docs/changes/2026-07-04-markdown-readability-contract/change.yaml --path docs/changes/2026-07-04-markdown-readability-contract/review-log.md --path docs/changes/2026-07-04-markdown-readability-contract/review-resolution.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/proposal-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/proposal-review-r2.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/spec-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/plan-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/test-spec-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m1-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m1-r2.md`: passed after code-review M1 R2.
- `git diff --check -- docs/changes/2026-07-04-markdown-readability-contract docs/plans/2026-07-04-markdown-readability-contract.md docs/plan.md`: passed after code-review M1 R2.
- `python scripts/validate-markdown-readability.py README.md VISION.md`: passed before code-review M1 R3 with audit-only warning summary `MDREAD-002=63, MDREAD-003=5`.
- `python scripts/validate-review-artifacts.py --mode structure docs/changes/2026-07-04-markdown-readability-contract`: passed after code-review M1 R3 with 8 reviews, 4 findings, 8 log entries, and 4 resolution entries.
...
- `python scripts/validate-review-artifacts.py --mode structure docs/changes/2026-07-04-markdown-readability-contract`: passed after code-review M2 R1 with 9 reviews, 4 findings, 9 log entries, and 4 resolution entries.
- `python scripts/validate-change-metadata.py docs/changes/2026-07-04-markdown-readability-contract/change.yaml`: passed after code-review M2 R1.
- `python scripts/validate-artifact-lifecycle.py --mode explicit-paths --path docs/proposals/2026-07-04-markdown-readability-contract.md --path specs/markdown-readability-contract.md --path specs/markdown-readability-contract.test.md --path docs/plans/2026-07-04-markdown-readability-contract.md --path docs/plan.md --path docs/changes/2026-07-04-markdown-readability-contract/change.yaml --path docs/changes/2026-07-04-markdown-readability-contract/review-log.md --path docs/changes/2026-07-04-markdown-readability-contract/review-resolution.md --path docs/changes/2026-07-04-markdown-readability-contract/markdown-readability-behavior-preservation.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/proposal-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/proposal-review-r2.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/spec-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/plan-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/test-spec-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m1-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m1-r2.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m1-r3.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m2-r1.md`: passed after code-review M2 R1.
- `git diff --check -- docs/changes/2026-07-04-markdown-readability-contract docs/plans/2026-07-04-markdown-readability-contract.md docs/plan.md`: passed after code-review M2 R1.
- `python scripts/validate-review-artifacts.py --mode structure docs/changes/2026-07-04-markdown-readability-contract`: passed after explain-change with 9 reviews, 4 findings, 9 log entries, and 4 resolution entries.
- `python scripts/validate-change-metadata.py docs/changes/2026-07-04-markdown-readability-contract/change.yaml`: passed after explain-change.
- `python scripts/validate-markdown-readability.py docs/changes/2026-07-04-markdown-readability-contract/explain-change.md docs/changes/2026-07-04-markdown-readability-contract/review-resolution.md`: passed after explain-change with audit-only warning summary `MDREAD-002=26, MDREAD-003=6`.
- `python scripts/validate-artifact-lifecycle.py --mode explicit-paths --path docs/proposals/2026-07-04-markdown-readability-contract.md --path specs/markdown-readability-contract.md --path specs/markdown-readability-contract.test.md --path docs/plans/2026-07-04-markdown-readability-contract.md --path docs/plan.md --path docs/changes/2026-07-04-markdown-readability-contract/change.yaml --path docs/changes/2026-07-04-markdown-readability-contract/review-log.md --path docs/changes/2026-07-04-markdown-readability-contract/review-resolution.md --path docs/changes/2026-07-04-markdown-readability-contract/explain-change.md --path docs/changes/2026-07-04-markdown-readability-contract/markdown-readability-behavior-preservation.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/proposal-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/proposal-review-r2.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/spec-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/plan-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/test-spec-review-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m1-r1.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m1-r2.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m1-r3.md --path docs/changes/2026-07-04-markdown-readability-contract/reviews/code-review-m2-r1.md`: passed after explain-change.
- `git diff --check -- docs/changes/2026-07-04-markdown-readability-contract docs/plans/2026-07-04-markdown-readability-contract.md docs/plan.md`: passed after explain-change.
- `python scripts/test-markdown-readability-validator.py`: passed during final verify with 7 tests.
- `python scripts/test-select-validation.py`: passed during final verify with 125 tests.
- `python scripts/validate-markdown-readability.py`: passed during final verify with audit-only warning summary `MDREAD-002=63, MDREAD-003=5`.
...
- `python scripts/test-build-skills.py`: passed during final verify with 7 tests.
- `python scripts/test-adapter-distribution.py`: passed during final verify with 130 tests.
- `python scripts/validate-review-artifacts.py --mode structure docs/changes/2026-07-04-markdown-readability-contract`: passed during final verify with 9 reviews, 4 findings, 9 log entries, and 4 resolution entries.
- `python scripts/validate-change-metadata.py docs/changes/2026-07-04-markdown-readability-contract/change.yaml`: passed during final verify.
