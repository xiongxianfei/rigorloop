...
- Latest review evidence: the canonical architecture and superseding ADR now implement the approved release-manifest and read-only package-rollback boundary
- Last reviewed milestone: M2
- Review status: review-requested; stage=architecture-review; round=r3
- Remaining in-scope implementation milestones: M3, M4
- Next stage: architecture-review R3 for the simplified activation contract
