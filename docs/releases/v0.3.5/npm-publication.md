...
target_init_smoke:
  codex:
    command: "npx @xiongxianfei/rigorloop@0.3.5 init codex --json"
    npm_version: "0.3.5"
...
| claude | `npx @xiongxianfei/rigorloop@0.3.5 init claude --json` | `0.3.5` | pending publication | pending public archive URL | pending | pending | pending | pending live command output summary | pending | pending | pending-publication | live-smoke-pending |
| opencode | `npx @xiongxianfei/rigorloop@0.3.5 init opencode --json` | `0.3.5` | pending publication | pending public archive URL | pending | pending | pending | pending live command output summary | pending | pending | pending-publication | live-smoke-pending |
