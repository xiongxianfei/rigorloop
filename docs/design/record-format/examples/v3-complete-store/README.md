...
These examples use the v3 schema and contract. V2 validation cannot establish v3 conformance. No existing record is converted, and no example save or schema check activates the new contract.
