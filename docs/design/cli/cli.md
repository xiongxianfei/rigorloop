...
| Compatibility/migration | CLI-SR-10, CLI-SR-18, CLI-SR-22, CLI-SR-23, CLI-SR-27, CLI-SR-28 | After the explicit v2 retirement disposition, only v3 stores are operational. Independent transports and accurate early-error tags remain unchanged. Bounded archive recognition does not hide malformed current data or interrupted storage. Retained applicable checks protect v3; this initiative adds no v2 retirement or rejection cases. |
