...
This scenario applies [CLI-SR-24–27](../../cli.md#requirements) to the [stored Review before](../../../record-format/examples/v3-review-limitations-update/before.json) and [after](../../../record-format/examples/v3-review-limitations-update/after.json). Messages are complete proposed envelopes, not executable v3 validation or actual assessments.
