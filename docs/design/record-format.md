...
| RF-SR-06 | Existing v1 records MUST retain their original discriminator and exact compatibility semantics. Reads MUST expose unavailable origin honestly; recording MUST NOT synthesize historical basis, mix versions or migrate a root implicitly. |
...
| Compatibility/migration | RF-SR-01, RF-SR-06 | V1 remains v1 and reports unavailable origin; unknown contracts and mixed versions reject instead of being guessed or migrated. |
