...
Use existing shared-source infrastructure: canonical compact core, feature-authoring and proof references move respectively to templates/shared/boundary-first-method-v1.md, templates/shared/boundary-first-feature-authoring-v1.md and templates/shared/boundary-first-proof-v1.md. The closed manifest moves to scripts/boundary-first-resources.yaml. These are maintained authoring inputs under Design/Validation ownership, not archived specs or a new public skill. Resource IDs remain compact-core, feature-authoring and proof, retaining the current consumer lists and skill-relative targets. Initial relocation preserves raw method bytes; update manifest identities and source containment checks coherently. Later method changes follow normal owning Design and package review, not hand-edited copies.
