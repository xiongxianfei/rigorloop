...
The [shared selection procedure](../../../test-design/rules.md#select-requirements-and-proof) gives this accounting its meaning: AUTH-SR-01's owner separation is observed by refinement/correction cases; AUTH-SR-02's bounded authority by scope and changing-basis cases; AUTH-SR-03's goal preservation by refinement and upstream-conflict cases; AUTH-SR-04's stable intent/exact handoff by scope cases; AUTH-SR-05's consumer and historical preservation by correction/reconciliation. No current requirement is omitted because its implementation is expensive or semantic. [Proposal](../proposal.md#test-design), [Design](../design.md#test-design) and [Plan](../plan.md#test-design) own local selection and method proof; this catalog adds only the failures visible across their interfaces.
